...
drone1 = input("Enter lat,lon,alt,pitch1,yaw1 of Drone 1 ")
lat1,lon1,alt1,pitch1,yaw1 = drone1.split(",")
drone2 = input("Enter lat,lon,alt,pitch,yaw of Drone 2 ")
lat2,lon2,alt2,pitch2,yaw2 = drone2.split(",")
